...
module.exports = class AdminModel {
    ...
    async addStudent(form_data) {
        var transactionQuery = "INSERT INTO `mst_student` (`birth_date`,`birth_place`,`cast`,`register_number`,`first_name`,`middle_name`,`last_name`,`mother_name`, `address`, `contact_number`, `class`,`roll_no`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        form_data.mother_name, form_data.address, form_data.contact_number, form_data.class,form_data.roll_no]);
    }
